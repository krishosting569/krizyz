                ...
                if ( global.db.data.users[m.sender].batu > benteng * count ) {
                   ...
                   user.batu >= pertambangan * count
                    ...
                    user.batu -= rumahsakit * count
                       ...
                       default:
                        return conn.sendButtonLoc(m.chat, 'https://telegra.ph/file/a035a809dc4d4937695c4.jpg', caption, `⌨️Typing to build
...
Official By @${'0'.split('@')[0]}`, 'Rules', '.rules', m)
        ...
        conn.sendButtonLoc(m.chat, 'https://telegra.ph/file/a035a809dc4d4937695c4.jpg', caption, `⌨️Typing to build
${usedPrefix}build <type>
⌨️Typing to upgrade:
${usedPrefix}upgrade <type> [ FITUR TIDAK TERSEDIA ]
