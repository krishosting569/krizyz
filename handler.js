...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = '© krizyz-bot'
        global.author = 'Made By Kris Host © 2022'
        global.packname2 = 'Made With'
        global.author2 = 'krizyz Bot By Kris Host © 2022'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By Kris Host˚'
        global.wm2 = '© krizyz-bot' + ' ' + 'By Kris Hosy'
        global.wm = '© krizyz-bot'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'By Kris Host'
        global.kontak2 = [
        ['62882007324217', 'Kris Hosting', 'Creator Bot', 'KrisHosring@support.com', true],
        ['6285786211623', 'Krizyz-Bot', 'Bot WhatsApp', 'Kriz Bot', true]
        ]
   ...
   await conn.sendButtonDoc(id, text, wm, action == 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : 'krizyz-bot', fkontak,{
