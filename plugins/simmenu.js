 ...
 *Powered By @${'16199961931'.split('@')[0]}*` 
  ...
  let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
    ...
    status: 1,
    surface : 1,
    message: `KRIZYZ 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`, 
    orderTitle: `▮Menu ▸`,
    ...
    const fkgif = {
	 ...
	 { remoteJid: "62882007324217-1625305606@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":`KRIZYZ 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `KRIZYZ 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 'jpegThumbnail': await (await fetch('https://telegra.ph/file/a035a809dc4d4937695c4.jpg')).buffer()
                        }
	                  } 
                     }
     if (teks == '404') { 
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: KRIZYZ*
⚘ *Creator: Kris Hosting*
⚘ *Contact Owner Bot*
*http://wa.me/62882007324217*
⚘ *Tanggal: 9 Juli 2022*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
 ...
 *Official Bot By @${'0'.split('@')[0]}* 
 *Powered By @${'62882007324217'.split('@')[0]}*`
       let judul = `${ucapanl()}`.trim() 
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ KRIZYZ",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ KRIZYZ",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ KRIZYZ",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di KRIZYZ",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
 ...
         externalAdReply: { 
             title: 'Krizyz Testing Project By Kris Hosting', 
...
handler.command = /^(simplemenu)$/i
 ...
 //By kris hosting  = https://github.com/wahyuricky737
  
  async function genProfile(conn, m) { 
   let font = await jimp.loadFont('./name.fnt'), 
     mask = await jimp.read('https://i.imgur.com/552kzaW.png'), 
     welcome = await jimp.read(thumbnailUrl.getRandom()), 
     avatar = await jimp.read(await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://telegra.ph/file/70c115bc3f109f5fcc889.jpg')), 
